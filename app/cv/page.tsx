  ...
  return (
    <section className={`mb-6 print:mb-4 print:break-inside-avoid ${className}`}>
      <header className="flex items-center gap-2 mb-3 print:mb-2  pb-2">
        <span className="text-blue-600 print:text-gray-700" aria-hidden="true">
          {icon}
        </span>
        <h2 className="text-lg font-semibold text-gray-900 uppercase tracking-wide print:text-base">{title}</h2>
      </header>
      ...
      <header className="mb-2">
        <div className="flex space-y-0 items-start justify-between gap-2">
          <div className="flex-1 space-y-0 ">
            ...
            <p className="text-blue-600 print:text-gray-700 font-medium text-sm print:text-xs">{company}</p>
          </div>
      ...
      <ul className="space-y-0 text-sm print:text-xs text-gray-700">
        {achievements.map((achievement, index) => (
          <li key={index} className="flex gap-2 leading-relaxed">
            <span className="text-blue-600 print:text-gray-600 flex-shrink-0" aria-hidden="true">
              •
            </span>
  ...
  return (
    <div className="mb-4 print:mb-3">
      <h3 className="flex items-center gap-2 font-medium text-gray-900 text-sm mb-2">
        <span className="text-blue-600 print:text-gray-600" aria-hidden="true">
          {icon}
        </span>
        {title}
      </h3>
      <div className="flex flex-wrap gap-1">
        {skills.map((skill) => (
          <span key={skill} className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded border print:border-gray-300">
            {skill}
          </span>
        ))}
      </div>
      ...
      <div className="cv-container bg-white print:bg-white">
        <div className="p-8 print:p-0">
          ...
          <header className="mb-8 print:mb-6 no-break">
            <div className="text-center border-b-2 border-blue-600 print:border-gray-400 pb-6">
              <h1 className="text-3xl print:text-2xl font-bold text-gray-900 mb-2">Paulo Neves</h1>
              <p className="text-xl print:text-lg text-blue-600 print:text-gray-700 font-medium mb-4">Full Stack Engineering Manager | People Leader</p>

              {/* Contact Information */}
              <div className="flex flex-wrap justify-center gap-4 text-sm print:text-xs text-gray-600">
                <a href="mailto:paulo@psneves.com.br" className="flex items-center gap-1 hover:text-blue-600 print:text-gray-700">
                ...
                <a href="https://br.linkedin.com/in/psneves" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-blue-600 print:text-gray-700">
                  <Linkedin size={14} aria-hidden="true" />
                  LinkedIn
                </a>
                <a href="https://github.com/psneves" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-blue-600 print:text-gray-700">
                  <Github size={14} aria-hidden="true" />
                  GitHub
                </a>
                <a href="https://psneves.com.br" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-blue-600 print:text-gray-700">
              ...
              <Section title="Languages" icon={<Languages size={16} />} className="no-break">
                <div className="space-y-2 text-sm print:text-xs">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-blue-600 print:text-gray-700">Native</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-700">English</span>
                    <span className="font-medium text-blue-600 print:text-gray-700">Fluent</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <Section title="Education" icon={<GraduationCap size={16} />} className="no-break">
                <div className="space-y-0 print:space-y-0">
                  <div className="space-y-0 mb-6">
                    ...
                    <p className="text-blue-600 print:text-gray-700 text-sm print:text-xs">Bachelor in Computer Science</p>
                  ...
                  <div className="space-y-0">
                    ...
                    <p className="text-blue-600 print:text-gray-700 text-sm print:text-xs">Post-graduate, Information Security Management</p>
